    ...
    <div className="cv-page main-content">
      ...
      <section className="cv-section about">
        ...
        <p className="cv-summary">
          ...
          designing experimental interfaces, soft technologies, and speculative
          interactive objects. my work explores inclusive tech practices,
          open-source development, and creative research — with the goal of
          expanding access to creative computing and enabling expressive,
      ...
      <section className="cv-section experience">
        ...
        <div className="cv-list">
          ...
          <div className="cv-item">
            ...
            <p className="cv-summary">
              supported professor dan shiffman in teaching and mentoring for the
              creative computing course, a new minor open to all nyu students,
          ...
          <div className="cv-item">
            ...
            <p className="cv-skills">
              <span className="label">skills:</span> react.js, figma, digital
              accessibility
            </p>
          </div>
        ...
        <div className="cv-list">
          <div className="cv-item">
            ...
            <p className="cv-summary">
              ...
              publishing within nyu’s print + code curriculum.
            </p>
          </div>
